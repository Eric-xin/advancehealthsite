...
const footerLinks = [
  ...
  },
  {
    title: 'Resources',
    links: [
      { name: 'Code of Conduct', href: '/coming-soon' },
      { name: 'Judging Criteria', href: '/coming-soon' },
      { name: 'Past Projects', href: '/coming-soon' },
      { name: 'Media Kit', href: '/coming-soon' },
    ],
  },
  {
    title: 'Contact',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            &copy; 2026 AdvanceHealth, <a href="https://github.com/eric-xin">Eric Xin</a>. All rights reserved.
          </p>
