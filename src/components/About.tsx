...
const features = [
  {
    ...
    description: 'Push the boundaries of healthcare technology with cutting-edge solutions.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Diverse Teams',
    description: 'Connect with developers, designers, clinicians, and researchers.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Real Impact',
    description: 'Build solutions that can genuinely improve patient outcomes.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Learn & Grow',
    description: 'Workshops, mentorship, and hands-on experience with healthcare data.',
  },
];
